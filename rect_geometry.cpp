...
Rectangle::Rectangle(const int llx, conts int lly,const urx,const ury):Polygon(updtaeConstructorPoints(Point(llx,lly),Point(llx,ury),Point(urx,ury),Point(urx,lly)),4){}
